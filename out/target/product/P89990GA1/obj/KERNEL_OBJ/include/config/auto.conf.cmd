deps_config := \
	...
	drivers/usb/typec/tcpc/Kconfig \
	...
	drivers/power/supply/wt_charger/Kconfig \
	...
	drivers/input/touchscreen/NT36523W/Kconfig \
...
ifneq "$(srctree)" "/home/chenyl6/oak-tb128-kernel/wifi/kernel-4.19.157"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/chenyl6/oak-tb128-kernel/wifi/prebuilts/clang/host/linux-x86/clang-r353983c/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
